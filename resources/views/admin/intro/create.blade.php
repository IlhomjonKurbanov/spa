    ...
    <div class="portlet-body form">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-green sbold uppercase">Thêm nội dung</span>
            </div>
        </div>
        <form action="{{url('create_intro_form')}}" class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-body">
