...
<head>
    <meta charset="utf-8" />
    <title>Muadotot.com | Admin Dashboard</title>
...
<div class="page-wrapper">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            ...
                            <span class="username username-hide-on-mobile"> Quản trị viên </span>
    ...
    <!-- END SIDEBAR -->
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- BEGIN PAGE TITLE-->
                <h1 class="page-title"> Quản trị ứng dụng Đông Á Beauty
    ...
    <div class="page-footer">
        <div class="page-footer-inner"> 2016 &copy; Admin muadotot.com
